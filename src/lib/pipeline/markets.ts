 ...
 */
export function computeMarketProfits(sold: SoldListing[], buyPriceKRW: number, weightGrams: number): MarketProfit[] {
  const matched = sold.filter((l) => l.matched && l.priceKRW > 0);
